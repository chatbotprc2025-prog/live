...
"[project]/app/api/admin/exam-timetable/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].examTimetable.findMany({
            where,
            orderBy: [
                {
                    examDate: 'asc'
...
async function POST(request) {
    try {
        ...
        if (isNaN(d.getTime())) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid examDate. Use YYYY-MM-DD'
            }, {
                status: 400
            });
        }
        body.examDate = d;
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].examTimetable.create({
            data: body
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__69b20726._.js.map