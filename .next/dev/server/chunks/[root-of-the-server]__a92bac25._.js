...
"[project]/app/api/admin/rooms/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const rooms = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].room.findMany({
            orderBy: [
                {
                    buildingName: 'asc'
                },
...
async function POST(request) {
    try {
        ...
        const room = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].room.create({
            data: {
                roomCode,
                buildingName,
                floor,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a92bac25._.js.map