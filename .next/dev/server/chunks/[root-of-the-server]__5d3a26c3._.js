...
"[project]/app/api/admin/class-timetable/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].classTimetable.findMany({
            where,
            orderBy: [
                {
                    programName: 'asc'
...
async function POST(request) {
    try {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].classTimetable.create({
            data: body
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5d3a26c3._.js.map