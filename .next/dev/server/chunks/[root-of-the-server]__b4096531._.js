...
async function GET(request) {
    try {
        const conversations = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].conversation.findMany({
            include: {
                messages: {
                    orderBy: {
                        createdAt: 'desc'
...
async function POST(request) {
    try {
        ...
        const { title } = body;
        const conversation = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].conversation.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b4096531._.js.map